    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (keuze != "9")
            {
                ...
                {
                    // TODO: Afmaken
                    decimal terugGeven = decimal.Parse(Console.ReadLine());
                    Console.WriteLine("Uitvoeren terugbetaling.");
                    decimal original = decimal.Parse(Console.ReadLine());
                    Console.WriteLine("Bedrag originele bon:");
                    Console.WriteLine("Reden retour:");
                    Console.WriteLine($"Dagtotaal is {((original - terugGeven))}C2:");

                }
                // TODO: If-statement corrigeren
                else if (keuze == 3.ToString())
                {
                    // TODO: Afmaken
                    Console.WriteLine("Dagtotalen");
                    Console.WriteLine("In kassa begint" + bedragInKassaBegin.ToString());
